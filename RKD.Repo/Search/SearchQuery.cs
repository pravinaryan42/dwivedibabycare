...
namespace RKD.Repo.Search
{
    public class SearchQuery<TEntity>
    {
        public SearchQuery()
        {
            ...
            SortCriterias = new List<DataTable.Sort.ISortCriteria<TEntity>>();
        }
        ...
        /// </summary>
        public List<DataTable.Sort.ISortCriteria<TEntity>> SortCriterias
        {
            get;
            protected set;
        }
        ...
        public void AddSortCriteria(DataTable.Sort.ISortCriteria<TEntity> sortCriteria)
        {
