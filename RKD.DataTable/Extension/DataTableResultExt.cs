using RKD.DataTable.DataTables;
...
namespace RKD.DataTable.Extension
{
    /// <summary>
    ...
    public class DataTableResultExt : ActionResult, IDataTableResult<List<DataTableRow>>
    {
        ...
        public DataTableResultExt(DataTables.DataTable dataTable, int iTotalRecords = 0, int iTotalDisplayRecords = 0, List<DataTableRow> aaData = null)
